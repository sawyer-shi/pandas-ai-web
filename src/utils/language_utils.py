class LanguageUtils:
    ...
    LANGUAGE = {
        "zh": {
            ...
            "chat_history": "对话记录",
            "refresh_history": "加载所有记录",
            "history_time": "时间",
            "history_session": "会话ID（可能包含多次问答）",
            "history_question": "问题",
            "history_answer": "回答",
            "chart_action": "图表操作",
            "load_record_action": "点击加载数据",
            "delete_action": "删除操作",
            ...
            "chat_history_tip": "这里显示所有对话记录，可以查看历史问题和回答。点击\"点击加载数据\"按钮可以加载对应的会话。",
            "no_history": "暂无对话记录",
            "last_updated": "最后更新时间:",
            ...
            "chart_tag": "[图表]",
            "delete_this_record": "删除此条",
            "search_question": "搜索问题",
            "search_placeholder": "输入问题关键词进行搜索",
            "search_button": "搜索",
            "search_results": "搜索结果",
            "no_search_results": "未找到匹配的记录"
        },
        "en": {
            ...
            "refresh_history": "Load All Records",
            "history_time": "Time",
            "history_session": "Session ID (May include multiple Q&A)",
            "history_question": "Question",
            "history_answer": "Answer",
            "chart_action": "Chart Action",
            "load_record_action": "Click to Load Data",
            ...
            "chart_tag": "[Chart]",
            "delete_this_record": "Delete",
            "search_question": "Search Question",
            "search_placeholder": "Enter keywords to search questions",
